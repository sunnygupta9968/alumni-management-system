  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-3">
        <li class="nav-item">
          <a class="nav-link fs-4" aria-current="page" href="#">Events</a>
        </li>
        <li class="nav-item">
   ...
   <p class="my-0"><i class='bx bxs-badge-check'></i>Verified</p>
          ...
          <ul class="dropdown-menu py-0" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item my-1 fs-6" href="#"><i class="fas fa-sliders-h fa-fw"></i> Account</a></li>
            <li><a class="dropdown-item my-1 fs-6" href="#"><i class="fas fa-cog fa-fw"></i> Settings</a></li>
           
            <li><a class="dropdown-item my-1 fs-6" href="#"><i class="fas fa-sign-out-alt fa-fw"></i> Log Out</a></li>
          </ul>
        </li>
     </ul>
      </c:if> 
