...
<c:if test="${not empty alumniObj}" >
    ...
    <i class='bx bxs-badge-check'></i>
      ...
      <div class="col-lg-8">
        ...
        <button type="button" class="btn google-btn w-25 mx-4 "><a href="editProfile.jsp" class="text-decoration-none" style="color:inherit;">Edit Profile</a></button>
         <button type="button" class="btn google-btn w-25 mx-4 ">Delete Account</button>
      </div>
